...
const UserPage = () => {
    ...
    const ConfirmModal = (props) => {
        ...
        const {openModal, setOpenConfirmModal} = props
                ...
                >
                    ...
                    <DialogContent>
                        <div className={'confirmModalContent'}>
                            <p className="w-full title">Are you sure you want to delete it?</p>
                            <p className="w-full description">Deletion will not be recovered</p>
    ...
    const DownloadItemCard = (props) => {
        const { image, setOpenConfirmModal } = props;
        return (
            <>
                <div className={'DownloadItemCard hidden lg:flex'}>
                    ...
                    <div className={'actionButtons'}>
                        <div className={'deleteBtn'} onClick={()=>setOpenConfirmModal(true)}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
    ...
    const TabBody = (props) => {
        const {setOpenConfirmModal} = props
        if (activeTab == 'project') {
            ...
            return (
                <>
                    <div className={'tabBodyContainer'}>
                        <div className={'container'}>
                            <DownloadItemCard image={DeletedImg} setOpenConfirmModal={setOpenConfirmModal}/>
                            <DownloadItemCard image={ItemImage} setOpenConfirmModal={setOpenConfirmModal}/>
                            <DownloadItemCard image={ItemImage} setOpenConfirmModal={setOpenConfirmModal}/>
                            <DownloadItemCard image={ItemImage} setOpenConfirmModal={setOpenConfirmModal}/>
                            <DownloadItemCard image={DeletedImg} setOpenConfirmModal={setOpenConfirmModal}/>
                            <DownloadItemCard image={ItemImage} setOpenConfirmModal={setOpenConfirmModal}/>
                            ...
                            <DownloadItemCard image={ItemImage} setOpenConfirmModal={setOpenConfirmModal}/>
                            <DownloadItemCard image={ItemImage} setOpenConfirmModal={setOpenConfirmModal}/>
                            <ConfirmModal openModal={openConfirmModal} setOpenConfirmModal={setOpenConfirmModal}/>
                            <Pagination totalPages={10} currentPage={3} />
                        </div>
                    </div>
                </>
    ...
    return (
        <>
            ...
            <AuthorSection />
            <TabHeader />
            <TabBody setOpenConfirmModal={setOpenConfirmModal}/>
        </>
    )
}
